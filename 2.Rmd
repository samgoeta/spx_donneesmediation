---
title: "Expédition de données sur l'alimentation"
subtitle: "Réunion du réseau des référents data, Région Occitanie"
author: "Samuel Goëta, Datactivist"
date: "Montpellier puis Toulouse, `r format(Sys.Date(), '%d %b %Y')`"
output:
...
params:
  event: "Expédition de données sur l'alimentation"
...
* Se mettre **dans la peau d'un réutilisateur**

* Comprendre **comment améliorer l'ouverture de ses données**

---
class:inverse,middle,center

## Rappel : le data pipeline
...
### Définir, c'est trouver un .red[angle] à votre sujet

![](./img/expe.png)
.footnote[[](https://fr.okfn.org/2014/07/03/a-la-conquete-des-donnees-sur-la-pollution-de-lair/)]

---
### Les angles proposés par l'équipe agriculture/alimentation

* Quel pourcentage de la viande consommée en restauration collective provient d'Occitanie ?

* Quels sont les produits originaires d’Occitanie ? A quel niveau (création, assemblage, emballage, autre ?) 

* Quel niveau de détail de traçabilité de l’origine Occitanie pouvons-nous avoir ? Par exemple dans le cas d’une viande : né/élevé/abattu en Occitanie ? Dans le cas de produits transformés en Occitanie (confiture, plats préparés, yaourt..) : peut-on avoir l’origine de la matière première ?

* Par catégorie de produits : quels volumes de production en Occitanie ? (voir peut-être du côté de Agreste, ou France Agri Mer pour les données)
...
---
### Utiliser .red[Google] Dataset Search
...
![](./img/dataods.png)
---
### Trouver le bon .red[tag] sur OSM
...
---
### Open .red[Refine] pour nettoyer les données
...
---
### Les .red[trois qualités] d'une visualisation 

.center.reduite[
![](https://datactivist.coop/infolab_poitiers/dataviz_sandwich/img/Venn_Dataviz.png)
]
---

### L'.red[interprétation] des données
...
.footnote[Credits Hervé Le Bras]
...
.footnote[Credits XKCD]

---
### Les facteurs .red[cachés]
...
---
### Le périmètre du .red[dénominateur]
...
---
### Les .red[représentations graphiques] problématiques
...
---
### Les représentations .red[spatiales]
