---
title: "Données et médiation"
subtitle: "Séance 1"
author: "Samuel Goëta"
date: "Sciences Po Aix , `r format(Sys.Date(), '%d %b %Y')`"
output:
...
params:
  event: "Données et médiation"
  slug: spx_donneesmediation
---
...
Ces slides en ligne : `r paste0("http://https://samgoeta.github.io/", params$slug)`
...
* Renforcer votre **culture des données** par la pratique

* Avoir une **expérience de première main** avec les données

* Etre capable de **conduire des actions de médiation** avec les données

* Connaitre la **méthodologie générale de réutilisation** d'un jeu de données
...
* Les signalements sur la voie publique (à Paris)
...
* La rénovation énergétique des batiments 
